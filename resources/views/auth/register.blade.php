                                ...
                                <form class="mx-1 mx-md-4" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label" for="name">{{ __('Họ và tên') }}</label>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label" for="email">{{ __('Địa chỉ email') }}</label>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label"
                                                for="confirmpassword">{{ __('Xác nhận mật khẩu') }}</label>
                                    ...
                                    <div class="d-flex justify-content-center flex-column mx-4 mb-3 mb-lg-4">
                                        <button type="submit"
                                            class="btn btn-outline-primary btn-lg">{{ __('Đăng ký') }}</button>
                                        <p class="small fw-bold mt-2 pt-1 mb-0">Nếu có tài khoản vui lòng <a
                                                href="{{ url('/login') }}" class="link-danger">Đăng nhập</a></p>
                                    </div>
                                </form>
