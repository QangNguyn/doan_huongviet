<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white {{ Request::is('blog') ? 'active' : '' }} "
            ...
            <li class="nav-item ">
                <a class="nav-link text-white {{ Request::is('setting') ? 'active' : '' }} "
                    href="{{ route('setting.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">settings</i>
                    </div>
                    <span class="nav-link-text ms-1">Danh sách cấu hình</span>
                </a>
            </li>
            ...
            <li class="nav-item ">
                <a class="nav-link text-white {{ Request::is('users') ? 'active' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Tin nhắn</span>
                </a>
            </li>
